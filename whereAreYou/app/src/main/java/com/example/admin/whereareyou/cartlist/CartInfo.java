...
public class CartInfo {
    int list_image;
    String list_name, list_pricetext, list_category;//가격같은경우 나중에 100,000-> , 표현식 들어가야됨//int값으로 놓으니 터져서 String으롷 변환(가격부분)

    public CartInfo(int list_image, String list_category, String list_pricetext, String list_name) {
